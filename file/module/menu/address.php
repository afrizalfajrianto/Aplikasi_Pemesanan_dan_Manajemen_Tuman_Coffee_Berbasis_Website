    ...
    <main>
        ...
        <section class="hero-profile">
            ...
            <div class="account swipe-in">
                ...
                <div class="details">
                    <hr>
                    <h4>Recipient Name:<br><span><?php echo $recipient_name; ?></span></h4>
                    <h4>Address Line 1:<br><span><?php echo $address_line1; ?></span></h4>
                    <h4>Address Line 2:<br><span><?php echo $address_line2; ?></span></h4>
                    <h4>City:<br><span><?php echo $city; ?></span></h4>
                    <h4>Postal Code:<br><span><?php echo $postal_code; ?></span></h4>
                    <h4>Country:<br><span><?php echo $country; ?></span></h4>
                    <h4>Phone Number:<br><span><?php echo $phone_number; ?></span></h4>
                </div>
                <a class="edit" href="edit_address.php">Edit</a>
            </div>
        </section>
