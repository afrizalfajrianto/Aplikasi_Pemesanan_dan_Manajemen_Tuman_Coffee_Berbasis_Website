...
<body>
    <main>
        ...
        <section class="hero-product">
            <article>
                <h1 class="swipe-in">Espresso Based</h1>
            </article>
        </section>

        <section class="product">
            <?php foreach ($espresso_based_products as $product): ?>
                <article class="card">
                    ...
                    <div class="card__content | flow">
                        ...
                        <a href="../handle/handle_shop.php?product_id=<?= $product['id'] ?>" class="card__button button_shop">Shop</a>
                        <!-- Tambahkan tautan untuk menambahkan produk ke keranjang -->
                        <a href="../handle/handle_bag.php?product_id=<?= $product['id'] ?>" class="card__button button_add"><ion-icon
